                            ...
                            >
                                {
                                    ({ handleChange, handleSubmit, handleBlur, touched, errors, values }) => (
                                        <MDBContainer>
                                            ...
                                            <MDBRow className='my-3'>
                                                <MDBCol md={12}  >
                                                    <MDBCardTitle className="my-3">Status do Pruduto:</MDBCardTitle>
                                                    <MDBRadio checked={status == "ativo"} onChange={(e) => toggleStatus(e.target.value)} value="ativo" name='flexRadioDefault' id='flexRadioDefault1' label='Ativo' />
                                                    <MDBRadio checked={status == "inativo"} onChange={(e) => toggleStatus(e.target.value)} value="inativo" name='flexRadioDefault' id='flexRadioDefault2' label='Inativo' />
                                                </MDBCol>
                                            </MDBRow>
                                            <MDBRow className='my-3'>
                                                <MDBCol md={6}  >
                                                    <MDBInput
                                                        ...
                                                        placeholder="R$ 00,00"
                                                        onBlur={handleBlur('precoOriginal')}
                                                    />
                                                    <div style={{ color: '#DC4C64' }}>{touched.precoOriginal && errors.precoOriginal}</div>
                                                </MDBCol>
                                                <MDBCol md={6}  >
                                                    <MDBInput
                                                        value={values.precoFinal}
                                                        onChange={handleChange('precoFinal')}
                                                        required
                                                        label='Preço Final'
                                                        placeholder="R$ 00,00"
                                                        onBlur={handleBlur('precoFinal')}
                                                    />
                                                    <div style={{ color: '#DC4C64' }}>{touched.precoFinal && errors.precoFinal}</div>
                                                </MDBCol>
                                            </MDBRow>
                                            <MDBRow>
                                                <MDBCol md={6}>
